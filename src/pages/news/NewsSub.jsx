...
function createData(sn, NewsId, NewsName, CreatedDate, Author) {
  return { sn, NewsId, NewsName, CreatedDate, Author };
}

const rows = [
  createData("1", "2", "Rice Production In Illam", "2023", "Ram"),
  createData("1", "2", "Pesticide", "2023", "Ram"),
  createData("1", "2", " Chitwan is growing hub of agriculture", "2023", "Ram"),
  createData("1", "2", "Chitwan is growing hub of agriculture", "2023", "Ram"),
  createData("1", "2", "Chitwan is growing hub of agriculture", "2023", "Ram"),
  createData("1", "2", "Chitwan is growing hub of agriculture", "2023", "Ram"),
  createData("1", "2", "Chitwan is growing hub of agriculture", "2023", "Ram"),
      ...
      >
        <Stack direction="row" spacing={2} className="my-2 mb-2">
          <Autocomplete
            ...
            getOptionLabel={(rows) => rows.NewsName || ""}
            renderInput={(params) => (
              <TextField
                {...params}
                size="small"
        ...
        <Stack>
          <Button
            ...
            variant="contained"
            onClick={() => navigate("/news/newscreate")}
          >
            Create News
          </Button>
        </Stack>
