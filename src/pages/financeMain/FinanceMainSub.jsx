...
function createData(sn, FinanceId, FinanceName, CreatedDate, Author) {
  return { sn, FinanceId, FinanceName, CreatedDate, Author };
}

const rows = [
  createData("1", "2", "Rice", "2023", "Ram"),
  createData("1", "2", "Wheat", "2023", "Ram"),
  createData("1", "2", " Crop", "2023", "Ram"),
  createData("1", "2", "Maze", "2023", "Ram"),
  createData("1", "2", "Crop", "2023", "Ram"),
  createData("1", "2", "Crop", "2023", "Ram"),
  createData("1", "2", "Crop", "2023", "Ram"),
  createData("1", "2", "Crop", "2023", "Ram"),
...
export default function FinanceMainSub() {
      ...
      >
        <Stack direction="row" spacing={2} className="my-2 mb-2">
          <Autocomplete
            ...
            getOptionLabel={(rows) => rows.FinanceName || ""}
            renderInput={(params) => (
              <TextField
                {...params}
                size="small"
                label="Search By Finance Name"
                sx={{
                  marginLeft: "4px",
                  width: "250px",
        ...
        <Stack>
          <Button
            ...
            variant="contained"
            onClick={() => navigate("/financeMain/financeMainCreate")}
          >
            Create Finance
          </Button>
        </Stack>
