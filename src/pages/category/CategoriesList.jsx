...
function createData(sn, cat, num) {
  return { sn, cat, num };
}

const rows = [
  createData("1", "Category 1", "8"),
  createData("2", "Category 2", "7"),
  createData("3", "Category 3", "6"),
  createData("1", "Category 1", "8"),
  createData("2", "Category 2", "7"),
  createData("3", "Category 3", "6"),
  createData("1", "Category 1", "8"),
                      ...
                      <TableCell>
                        <Stack spacing={2} direction="row">
                          <EditIcon
                            ...
                            onClick={() => navigate("/categories/sub")}
                          />
                          <DeleteIcon
                            style={{
                              fontSize: "20px",
